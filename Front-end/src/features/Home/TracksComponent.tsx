    ...
    return (
        <div
            ...
            <div className="relative">
                ...
                <div
                    className="absolute transition-all duration-300 transform translate-y-2 opacity-0 box-play-btn right-2 bottom-2 group-hover:opacity-100 group-hover:translate-y-0">
                    <button className="cursor-pointer group/play">
						<span
                            className="bg-[#1ed760] group-hover/play:scale-105 group-hover/play:bg-[#3be477] rounded-full flex items-center justify-center w-12 h-12 text-black">
