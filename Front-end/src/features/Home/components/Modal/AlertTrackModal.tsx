...
const AlertTrackModal = ({open, setOpen}: AlertTrackModalProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className={`sm:max-w-[810px] border-none`}>
                    ...
                    <div className="flex flex-row items-center gap-10 p-10 pt-6">
                        ...
                        <div className="w-3/5">
                            <div className="flex flex-col gap-6 items-center">
                                ...
                                <Link to="/signup">
                                    <button
                                        className="text-black py-2 px-4 rounded-full font-bold text-sm bg-[#3be477] hover:scale-105 transition-all">
                                        Sign up for free
                                    </button>
                                </Link>
