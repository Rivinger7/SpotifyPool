...
{
    public class JwtBLL : IJwtBLL
    {
        private readonly IConfiguration _config;
        private readonly IUnitOfWork _unitOfWork;
        private readonly SpotifyPoolDBContext _context;

        public JwtBLL(IConfiguration config, IUnitOfWork unitOfWork, SpotifyPoolDBContext context)
        {
            _config = config;
        ...
        /// <exception cref="ErrorException"></exception>
        public void RefreshAccessToken(out string newAccessToken, out string newRefreshToken, TokenApiModel tokenApiModel)
        {
