...
namespace BusinessLogicLayer.Implement.Implement
{
	public class AuthenticationBLL : IAuthenticationBLL
	{
		...
		public AuthenticationBLL(ILogger<CustomerBLL> logger, IMapper mapper, IUnitOfWork unitOfWork, SpotifyPoolDBContext context, IJwtBLL jwtBLL, IEmailSenderCustom emailSender, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, UserManager<User> userManager, SignInManager<User> signInManager)
		{
			_logger = logger;
			_mapper = mapper;
